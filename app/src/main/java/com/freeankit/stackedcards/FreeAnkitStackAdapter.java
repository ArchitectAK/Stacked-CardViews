...
import com.freeankit.freestack.StackAdapter;

/**
 * Created by J6673234 on 31/07/2017.
 */

public class FreeAnkitStackAdapter extends StackAdapter<Integer> {

    public FreeAnkitStackAdapter(Context context) {
        super(context);
    }
